...
class SalesProduct {
  ...
  make_secoundary_body = (data) => {
    ...
    data.sales.forEach((sale) => {
      result += `
            <tr class="border-b">
                <td class="text-xs text-center font-normal text-gray-700 py-3">${
                  sale.name
                }</td>
                <td class="text-xs text-center font-normal text-gray-700 py-3">${
                  sale.name
                ...
                <td class="text-sm text-center font-normal text-gray-700 py-3">${
                  sale.branch
                }</td>
                <td class="text-xs text-center font-normal text-gray-700 py-3">$${
                  sale.price
    ...
    data.sales.forEach((sale) => {
      result += `
            <tr class="border-b">
                ...
                <td class="text-xs text-center font-normal text-gray-700 py-3">${formatedTimestamp(
                  sale.date
                )}</td>
                <td class="text-xs text-center font-normal text-gray-700 py-3">$${numberWithCommas(
                  sale.total
...
const generate_sales_employee_report = async (data) => {
...
module.exports = {
  generate_sales_employee_report,
  generate_sales_product_report,
